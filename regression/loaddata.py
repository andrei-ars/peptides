...
class DataBase():
    ...
    def __init__(self, path="data"):
        ...
        print("Loading ndata...")
        with open('data/ndata.pickle', 'rb') as fp:
            ndata = pickle.load(fp)

        ndata = ndata.astype(np.float64)
        columns_number = ndata.shape[1]
        print("ndata has been loaded; ndata shape = {}".format(ndata.shape))
        print("columns_number: {}".format(columns_number))
